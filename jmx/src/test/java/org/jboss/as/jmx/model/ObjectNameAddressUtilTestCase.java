...
public class ObjectNameAddressUtilTestCase {
    ...
    public void testToPathAddress() {
        ...
        ManagementResourceRegistration rootRegistration = ManagementResourceRegistration.Factory.forEnvironment(ProcessType.EMBEDDED_SERVER, RunningMode.NORMAL).createRegistry(rootResourceDef);
