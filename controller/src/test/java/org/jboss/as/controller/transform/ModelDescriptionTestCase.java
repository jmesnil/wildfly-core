...
public class ModelDescriptionTestCase {
    ...
    public static void setup() {
        registration = ManagementResourceRegistration.Factory.forEnvironment(ProcessType.EMBEDDED_SERVER, RunningMode.NORMAL).createRegistry(RootSubsystemResource.INSTANCE);
    ...
    public void testManagementResourceSerialization() {
        ...
        ManagementResourceRegistration loaded = ManagementResourceRegistration.Factory.forEnvironment(ProcessType.EMBEDDED_SERVER, RunningMode.NORMAL).createRegistry(definition);
