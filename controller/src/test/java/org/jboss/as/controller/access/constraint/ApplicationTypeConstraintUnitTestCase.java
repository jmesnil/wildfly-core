...
public class ApplicationTypeConstraintUnitTestCase {
    ...
    private void setupResources(boolean isA, boolean isB) {
        ...
        ManagementResourceRegistration rootRegistration = ManagementResourceRegistration.Factory.forEnvironment(ProcessType.EMBEDDED_SERVER, RunningMode.NORMAL).createRegistry(rootRd);
