    ...
    private class SubsystemRegistrationImpl implements SubsystemRegistration {
        ...
        private SubsystemRegistrationImpl(String name, ModelVersion version,
            ...
            if (deploymentsRegistration == null){
                this.deploymentsRegistration = ManagementResourceRegistration.Factory.forEnvironment(processType, runningMode.getRunningMode()).createRegistry(new SimpleResourceDefinition(null, NonResolvingResourceDescriptionResolver.INSTANCE));
            }else {
