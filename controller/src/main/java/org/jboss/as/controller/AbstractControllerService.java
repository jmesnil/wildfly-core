...
public abstract class AbstractControllerService implements Service<ModelController> {
    ...
    public void start(final StartContext context) throws StartException {
        ...
        ManagementResourceRegistration rootResourceRegistration = ManagementResourceRegistration.Factory.forEnvironment(processType, runningModeControl.getRunningMode()).createRegistry(rootResourceDefinition, authorizerConfig, capabilityRegistry);
