...
public class ManagementPermissionAuthorizerTestCase {
    ...
    private static final ManagementResourceRegistration ROOT_RR = ManagementResourceRegistration.Factory.forEnvironment(ProcessType.EMBEDDED_SERVER, RunningMode.NORMAL).createRegistry(new SimpleResourceDefinition(null, new NonResolvingResourceDescriptionResolver()) {
        @Override
