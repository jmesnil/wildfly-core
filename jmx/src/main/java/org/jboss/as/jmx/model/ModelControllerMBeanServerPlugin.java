...
public class ModelControllerMBeanServerPlugin extends BaseMBeanServerPlugin {
    ...
    public void removeNotificationListener(ObjectName name, NotificationListener listener) throws InstanceNotFoundException,
        ...
        PathAddress pathAddress = getHelper(name).resolvePathAddress(name);
        JMXNotificationHandler handler = new JMXNotificationHandler(name, listener, null, null);
        controller.getNotificationSupport().unregisterNotificationHandler(pathAddress, handler, handler);
    }
    ...
    private class JMXNotificationHandler implements NotificationHandler, org.jboss.as.controller.notification.NotificationFilter {
        ...
        /**
         * Create a WildFly NotificationHandler that wraps a JMX NotificationListener + NotificationFilter
         * @param name
         * @param listener
        ...
        @Override
        public boolean isNotificationEnabled(org.jboss.as.controller.notification.Notification notification) {
            if (filter == null) {
                return true;
            } else {
        ...
        @Override
        public void handleNotification(org.jboss.as.controller.notification.Notification notification) {
            javax.management.Notification jmxNotification = convert(name, notification);
            listener.handleNotification(jmxNotification, handback);
        }


        private javax.management.Notification convert(ObjectName objectName, org.jboss.as.controller.notification.Notification notification) {
